        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 relative">
                <ImgFondo>
                    ...
                    <div className="relative z-0 px-4 sm:px-8 pt-8 pb-20">
                        ...
                        {/* TABLA DE RESIDENTES */}
                        <div className="shadow-lg mt-6 bg-white rounded-lg max-w-full">
                            <div className="bg-white shadow-lg rounded">
                                {/* HEADER DE TABLA CON ACCIONES */}
                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center px-6 py-4 border-b gap-3">
                                    <span className="font-bold text-lg text-gray-800">
                                        Información de los residentes ({filteredUsers.length})
                                    </span>
                                    <button 
                                        className="px-4 py-2 bg-red-600 text-white text-sm rounded shadow hover:bg-red-700 transition-colors"
                                ...
                                <div className="bg-gray-100 px-6 py-6 rounded-b">
                                    <h3 className="text-center text-blue-600 font-bold text-xl mb-6">
                                            ...
                                            <div className="overflow-x-auto bg-white rounded-lg border border-gray-200">
                                                <table className="w-full">
                                                    <thead className="bg-gray-200 text-gray-700">
                                                        <tr>
                                                            <th className="px-6 py-4 text-left font-semibold">ID Usuario</th>
                                                            <th className="px-6 py-4 text-left font-semibold">Nombre Completo</th>
                                                            <th className="px-6 py-4 text-left font-semibold hidden lg:table-cell">Email</th>
                                                            <th className="px-6 py-4 text-left font-semibold">Torre</th>
                                                            <th className="px-6 py-4 text-left font-semibold">Apartamento</th>
                                                        ...
                                                        {currentUsers.length === 0 ? (
                                                            ...
                                                            currentUsers.map((user) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="px-6 py-4 hidden lg:table-cell text-gray-600">{user.email}</td>
                                                                    <td className="px-6 py-4">{user.torre}</td>
                                                                    <td className="px-6 py-4">{user.apartamento}</td>
                                                                    <td className="px-6 py-4">
                                                                        <span className={`text-sm px-3 py-1 rounded-full ${getBadgeColors(user.estado)}`}>
                                                                            {user.estado}
                                                                        </span>
                                                                    </td>
                                                                    <td className="px-6 py-4 text-center">
                                                                        <button 
                                                                            className="px-4 py-2 bg-blue-600 text-white text-sm rounded shadow hover:bg-blue-700 transition-colors"
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
