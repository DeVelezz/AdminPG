...
export default function PageActualizarInfo() {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        // Paso 1: Validaciones de datos personales
        if (page === 1) {
            if (!form.nombre.trim()) {
                Swal.fire({
                    icon: 'warning',
            ...
            // Si todo está bien, pasa al siguiente paso
            setPage(2);
            return;
        }
        // Paso 2: Validaciones de contraseña
        if (page === 2) {
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg w-112">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-between mt-8">
                                    <button
                                        type="button"
                                        className="px-4 py-2 bg-gray-300 text-black-700 rounded shadow hover:bg-gray-400"
                                    ...
                                    {page === 1 ? (
                                        <button
                                            type="submit"
                                            className="px-4 py-2 bg-gray-300 text--700 rounded shadow hover:bg-gray-400"
                                        >
                                            Siguiente
                                        </button>
                                    ) : (
