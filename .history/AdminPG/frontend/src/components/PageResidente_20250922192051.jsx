                                ...
                                {esDesdeMora ? (
                                    ...
                                    <div className="flex items-center gap-8">
                                        <div className="flex items-center gap-6">
                                            <span className={`font-semibold text-xl text-gray-800 border-b-4 ${getUnderlineColor(estadoGeneralResidente)}`}>
                                                {residente.nombre}
                                            </span>
                                            <span className="text-gray-600 ml-8">Torre {residente.torre} - Apto {residente.apartamento}</span>
                                        </div>
