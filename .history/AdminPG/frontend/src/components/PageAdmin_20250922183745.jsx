        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 relative">
                <ImgFondo>
                    ...
                    <div className="relative z-0 px-4 sm:px-5 pt-8 pb-5">
                        ...
                        {/* TABLA DE RESIDENTES */}
                        <div className="shadow-lg mt-6 bg-white rounded-lg">
                            <div className="bg-white shadow-lg rounded">
                                ...
                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center px-4 py-3 border-b gap-3">
                                    ...
                                    <button 
                                        className="px-3 py-2 bg-red-600 text-white text-sm rounded shadow hover:bg-red-700 transition-colors"
                                ...
                                <div className="bg-gray-100 p-4 sm:p-6 rounded-b">
                                    <h3 className="text-center text-blue-600 font-bold text-lg sm:text-xl mb-4">
                                    ...
                                    {loading ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="overflow-x-auto">
                                                <table className="w-full bg-white border rounded shadow min-w-[700px]">
                                                    <thead className="bg-gray-200 text-gray-700">
                                                        <tr>
                                                            ...
                                                            <th className="px-2 sm:px-4 py-2 text-left text-xs sm:text-sm">Torre</th>
                                                            <th className="px-2 sm:px-4 py-2 text-left text-xs sm:text-sm">Apto</th>
                                                            <th className="px-2 sm:px-4 py-2 text-left text-xs sm:text-sm">Estado</th>
                                                            <th className="px-2 sm:px-4 py-2 text-center text-xs sm:text-sm">Acción</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {currentUsers.length === 0 ? (
                                                            ...
                                                            currentUsers.map((user) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="px-2 sm:px-4 py-2 text-xs sm:text-sm font-medium">{user.nombre}</td>
                                                                    <td className="px-2 sm:px-4 py-2 text-xs sm:text-sm hidden md:table-cell">{user.email}</td>
                                                                    <td className="px-2 sm:px-4 py-2 text-xs sm:text-sm">{user.torre}</td>
                                                                    <td className="px-2 sm:px-4 py-2 text-xs sm:text-sm">{user.apartamento}</td>
                                                                    ...
                                                                    <td className="px-2 sm:px-4 py-2 text-center">
                                                                        <button 
                                                                            className="px-2 sm:px-3 py-1 bg-blue-600 text-white text-xs sm:text-sm rounded shadow hover:bg-blue-700 transition-colors"
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();
                                            ...
                                            {/* PAGINACIÓN */}
                                            {totalPages > 1 && (
                                                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white p-4 rounded border-t">
