            ...
            <main className="flex-1 flex flex-col relative z-0">
                <ImgFondo>
                    ...
                    <div className="relative z-10 p-5 flex flex-col pb-8">
                        <div className="flex flex-col items-center mt-12 mb-6 bg-transparent p-3 rounded-lg w-full">
                            <p className="text-white font-bold text-2xl text-center mb-2">RESIDENTES EN MORA</p>
