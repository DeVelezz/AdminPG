            ...
            <main className="flex-1 relative">
                <ImgFondo>
                    ...
                    <div className="relative z-10 px-5 pt-0 pb-5 -mt-30">
                        <div className="justify-between bg-transparent p-3 rounded-lg w-350 flex flex-row items-center">
                            <p className="text-black-600 font-bold text-xl">¡BIENVENIDO ADMIN!</p>
                        ...
                        <div className="shadow-lg mt-6">
                            <div className="bg-white shadow-lg rounded">
                                <div className="flex justify-between items-center px-4 py-3 border-b">
                                    <span className="font-semibold font-bold text-xl text-black-600">Información de los residentes</span>
